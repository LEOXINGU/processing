...
class FillRasterwithPatches(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        if self.LOC == 'pt':
            return "Preenche vazios de Raster (pixels nulos) com dados obtidos de outras camadas raster menores (Remendos)."
        else:
            return self.tr("Fills Raster null pixels (no data) with data obtained from other smaller raster layers (Patches).")
