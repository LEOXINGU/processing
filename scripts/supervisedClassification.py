...
class SupervisedClassification(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        if self.LOC == 'pt':
            return "Realize a classificação supervisionada de camada raster com duas ou mais bandas."
        else:
            return self.tr('Performs the supervised classification of a raster layer with two or more bands.')
