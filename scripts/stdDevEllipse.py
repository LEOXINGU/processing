...
class StdDevEllipse(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        txt_en = 'Creates standard deviational ellipses to summarize the spatial characteristics of point type geographic features: central tendency, dispersion, and directional trends.'
        txt_pt = 'Cria elipses de desvio padrão para resumir as características espaciais de feções geográficos do tipo ponto: tendência central, dispersão e tendências direcionais.'
