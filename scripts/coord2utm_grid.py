...
class Coord2UTMGrid(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        return self.tr("This algorithm returns the polygon correspondent to the <b>frame</b> related to a scale of the Brazilian Mapping System from geographic coordinates (longitude, latitude)")
