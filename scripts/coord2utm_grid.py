...
class Coord2UTMGrid(QgsProcessingAlgorithm):
    ...
    def displayName(self):
        ...
        return self.tr('Coordinates to UTM Grid')
    ...
    def shortHelpString(self):
        if self.LOC == 'pt':
            return "Este algoritmo retorna o polígono correspondente à <b>moldura</b> relativa a uma escala do <b>Mapeamento Sistemático Brasileiro</b>. Esta moldura é calculada a partir das coordenadas de um <b>Ponto</b> definido pelo usuário."
        else:
            return self.tr("This algorithm returns the polygon correspondent to the <b>frame</b> related to a scale of the <b>Brazilian Mapping System</b>. That frame is calculated from a <b>Point</b> definied by the user.")
